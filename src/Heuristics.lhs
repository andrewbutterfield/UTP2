...
exprSize (Num i)         = 2
exprSize (Var s)         = 2
exprSize (Prod es)       = 2 + esSize es
exprSize (App s e)       = 2 + exprSize e
exprSize (Bin s i e1 e2) = 2 + esSize [e1,e2]
exprSize (Equal e1 e2)   = 2 + esSize [e1,e2]
exprSize (Set es)        = 3 + esSize es
exprSize (Setc _ qs pr e)  = 3 + qSize qs + predSize pr + exprSize e
exprSize (Seq es)        = 3 + esSize es
exprSize (Seqc _ qs pr e)  = 3 + qSize qs + predSize pr + exprSize e
exprSize (Map drs)       = 3 + esSize (ds++rs)
  where (ds,rs) = unzip drs
exprSize (Cond pc et ee) = 4 + predSize pc +  esSize [et,ee]
exprSize (Build s es)    = 2 + esSize es
